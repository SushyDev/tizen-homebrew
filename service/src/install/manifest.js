 ...
 *
 * Returns `{ packageId, appId, name, version, isWgt }`, or throws when the
 * file is not a Tizen package at all — which is the useful thing to tell
 * someone who uploaded the wrong file.
 */
